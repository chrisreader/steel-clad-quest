...
export abstract class EnemyHumanoid {
  ...
  private createArms(
    ...
    leftArm.position.set(-(bodyScale.body.radius * 0.7), shoulderHeight, 0); // Center arms with shoulders
    ...
    rightArm.position.set(bodyScale.body.radius * 0.7, shoulderHeight, 0); // Center arms with shoulders
