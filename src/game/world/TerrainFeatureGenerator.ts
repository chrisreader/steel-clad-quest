...
import { RockVariation } from '../rocks/config/RockVariationConfig';

export class TerrainFeatureGenerator {
  public addTerrainFeatures(rockGroup: THREE.Group, rockVariation: RockVariation, basePosition: THREE.Vector3, intensity: number): void {
