...
export const ROCK_VARIATIONS: RockVariation[] = [
  { category: 'tiny', sizeRange: [0.3, 0.8], weight: 50, isCluster: false },
  { category: 'small', sizeRange: [0.8, 1.5], weight: 25, isCluster: false },
  { category: 'medium', sizeRange: [1.5, 3.0], weight: 15, isCluster: false },
  { category: 'large', sizeRange: [2.0, 4.0], weight: 7, isCluster: true, clusterSize: [3, 5] },
  { category: 'massive', sizeRange: [4.0, 8.0], weight: 3, isCluster: true, clusterSize: [4, 7] }
];
