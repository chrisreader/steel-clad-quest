...
export const ROCK_VARIATIONS: RockVariation[] = [
  ...
  { category: 'large', sizeRange: [2.0, 4.0], weight: 12, isCluster: true, clusterSize: [5, 8], shapePersonality: 'character' },
  { category: 'massive', sizeRange: [4.0, 8.0], weight: 6, isCluster: true, clusterSize: [6, 10], shapePersonality: 'character' }
];
